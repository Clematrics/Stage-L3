<project xmlns="com.autoesl.autopilot.project" name="onboard_processor" top="processor">
    ...
    <files xmlns="">
        ...
        <file name="onboard_processor/src/stages/write_back.cpp" sc="0" tb="false" cflags="-Ionboard_processor/include" csimflags="" blackbox="false"/>
        ...
        <file name="onboard_processor/src/stages/issue.cpp" sc="0" tb="false" cflags="-Ionboard_processor/include" csimflags="" blackbox="false"/>
        <file name="onboard_processor/src/architecture/immediate_packing.cpp" sc="0" tb="false" cflags="-Ionboard_processor/include" csimflags="" blackbox="false"/>
        ...
        <file name="onboard_processor/src/debug/debug_structs.cpp" sc="0" tb="false" cflags="-Ionboard_processor/include" csimflags="" blackbox="false"/>
        ...
        <file name="onboard_processor/src/components/compute_unit.cpp" sc="0" tb="false" cflags="-Ionboard_processor/include" csimflags="" blackbox="false"/>
        <file name="onboard_processor/src/stages/commit.cpp" sc="0" tb="false" cflags="-Ionboard_processor/include" csimflags="" blackbox="false"/>
        <file name="onboard_processor/src/architecture/architecture_helpers.cpp" sc="0" tb="false" cflags="-Ionboard_processor/include" csimflags="" blackbox="false"/>
    </files>
    <solutions xmlns="">
