...
add_files onboard_processor/src/components/compute_unit.cpp -cflags "-Ionboard_processor/include"
add_files onboard_processor/src/debug/debug_helpers.cpp -cflags "-Ionboard_processor/include"
add_files onboard_processor/src/debug/debug_structs.cpp -cflags "-Ionboard_processor/include"
...
add_files onboard_processor/src/stages/write_back.cpp -cflags "-Ionboard_processor/include"
...
config_compile -name_max_length 50  -pipeline_loops 0 
