<project xmlns="com.autoesl.autopilot.project" top="pipeline" name="pipeline">
    ...
    <files xmlns="">
        ...
        <file name="../tb/fetch_tb.cpp" sc="0" tb="1" cflags=" -Wno-unknown-pragmas" csimflags=" -Wno-unknown-pragmas" blackbox="false"/>
        <file name="../tb/decode_tb.cpp" sc="0" tb="1" cflags=" -Wno-unknown-pragmas" csimflags=" -Wno-unknown-pragmas" blackbox="false"/>
    ...
    <solutions xmlns="">
        <solution name="pipeline" status="active"/>
    </solutions>
</project>
