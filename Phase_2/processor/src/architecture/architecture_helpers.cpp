...
// TODO : relocate this, since Kind does not belong to architecture.hpp anymore
std::string to_string(Kind kind) {
	switch (kind) {
	case Decoding::Kind::alu:           return "alu";
	case Decoding::Kind::alu_immediate: return "alu_immediate";
