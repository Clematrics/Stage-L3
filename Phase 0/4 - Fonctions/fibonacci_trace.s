...
addi    s0, sp, 16          # addi    r015, r012, 16       | { sp → r012, ra → r013, s0 → r015, a0 → r007, a1 → r008, a2 → r009, x0 → r006 }
                            #                              |
beq     a0, x0, .fibL1      # beq     r007, r006, .fibL1   | { sp → r012, ra → r013, s0 → r015, a0 → r007, a1 → r008, a2 → r009, x0 → r006 }
addi    a0, a0, -1          # addi    r017, r007, -1       | { sp → r012, ra → r013, s0 → r015, a0 → r017, a1 → r008, a2 → r009, x0 → r006 }
...
addi    s0, sp, 16          # addi    r025, r022, 16       | { sp → r022, ra → r023, s0 → r025, a0 → r017, a1 → r019, a2 → r018, x0 → r006 }
                            #                              |
beq     a0, x0, .fibL1      # beq     r017, r006, .fibL1   | { sp → r022, ra → r023, s0 → r025, a0 → r017, a1 → r019, a2 → r018, x0 → r006 }
addi    a0, a0, -1          # addi    r027, r017, -1       | { sp → r022, ra → r023, s0 → r025, a0 → r027, a1 → r019, a2 → r018, x0 → r006 }
...
addi    s0, sp, 16          # addi    r035, r032, 16       | { sp → r032, ra → r033, s0 → r035, a0 → r027, a1 → r029, a2 → r028, x0 → r006 }
                            #                              |
beq     a0, x0, .fibL1      # beq     r027, r006, .fibL1   | { sp → r032, ra → r033, s0 → r035, a0 → r027, a1 → r029, a2 → r028, x0 → r006 }
addi    a0, a0, -1          # addi    r037, r027, -1       | { sp → r032, ra → r033, s0 → r035, a0 → r037, a1 → r029, a2 → r028, x0 → r006 }
...
addi    s0, sp, 16          # addi    r045, r042, 16       | { sp → r042, ra → r043, s0 → r045, a0 → r037, a1 → r039, a2 → r038, x0 → r006 }
                            #                              |
beq     a0, x0, .fibL1      # beq     r037, r006, .fibL1   | { sp → r042, ra → r043, s0 → r045, a0 → r037, a1 → r039, a2 → r038, x0 → r006 }
                            #                              |
